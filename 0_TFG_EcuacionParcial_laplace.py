...
def loss_function(W, x, y):
    ...
    for xi in x: # los nodos del intervalo que hemos escogido para x
        for yi in y: # los nodos del intervalo que hemos escogido para y
            ...
            func = EcuacionDiferencial(input_point)
            ...
            #
            # psy_t = salida_general(input_point, net_out)
            # psy_t_jacobian = jacobian(salida_general)(input_point, net_out)
            psy_t_hessian = jacobian(jacobian(salida_general))(input_point, net_out)
